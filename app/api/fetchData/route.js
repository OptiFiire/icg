...
export async function POST(request) {
    try {
        ...
        let text = "I want to see in what job I am good at so I can choose my career, here are the list of jobs and their states :\n"
...
RESULT MUST BE IN FORMAT { "PROFESSION": PERCENTAGE }, SHOW ONLY 3 OBJECTS IN RESPONSE WHICH ARE THE CLOSEST TO THE ANSWERS PROVIDED.
`
